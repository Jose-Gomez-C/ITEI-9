...
- Where is the *findAll* method implemented?
	El CustomerRepository implementa la interfaz MongoRepository, que extiende PagingAndSortingRepository, CrudRepository y Finally Repository.
	El método findAll está presente en estas interfaces pero no está implementado directamente, este método está implementado en el Repositorio de Spring por SpringFramework y este método fue generado usando meta-programación.  
...
- Suppose you have more than 1000 products in your database. How would you implement a method for supporting pagination and return pages of 50 products to your frontend?
	...
	```
	usar productRepository.findAll(PageRequest.of(número de páginas))
...
- How many products are returned by the *findByDescriptionContaining* query? Why?
	2 porque la consulta se está paginando en páginas de 2 elementos, y sólo estamos recibiendo la primera página.
